            ...
            <article class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="relative h-64 md:h-96 overflow-hidden">
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="px-4 py-2 bg-primary text-white text-sm font-medium rounded-full shadow-lg">
                            Kemahasiswaan
                        </span>
                    </div>
                </div>
                ...
                <div class="p-6 md:p-8">
                    ...
                    <div class="prose prose-lg max-w-none">
                        ...
                        <h2 class="text-2xl font-bold text-gray-900 mb-4 mt-8">Rangkaian Kegiatan</h2>
                        ...
                        <div class="bg-primary-light p-6 rounded-xl mb-6">
                            <h3 class="text-xl font-semibold text-primary-dark mb-3">Highlight Acara:</h3>
                        ...
                        <h2 class="text-2xl font-bold text-gray-900 mb-4 mt-8">Dampak dan Manfaat</h2>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-full">HMTI UHO</span>
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-full">Kemahasiswaan</span>
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-full">Teknologi</span>
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-full">Kompetisi</span>
                            <span class="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-full">Programming</span>
                        </div>
                    </div>

                    <!-- Share Buttons -->
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900 mb-3">Bagikan:</h3>
                        <div class="flex gap-3">
                            <a href="#" class="inline-flex items-center justify-center w-10 h-10 bg-blue-500 hover:bg-blue-600 text-white rounded-full transition-colors duration-200">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                                </svg>
                            </a>
                            <a href="#" class="inline-flex items-center justify-center w-10 h-10 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-colors duration-200">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
                            <a href="#" class="inline-flex items-center justify-center w-10 h-10 bg-green-500 hover:bg-green-600 text-white rounded-full transition-colors duration-200">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300">
                        ...
                        <div class="p-4">
                            <span class="inline-block px-3 py-1 bg-primary text-white text-xs font-medium rounded-full mb-2">
                                Akademik
                            </span>
                            <h3 class="text-lg font-bold text-gray-900 mb-2">DISKUSI AKADEMIS 2024</h3>
                            <p class="text-gray-600 text-sm mb-3">Telah terlaksana kegiatan Diskusi Akademis 2024 pada tanggal 5 Juli 2024...</p>
                            <a href="#" class="text-primary hover:text-primary-dark font-semibold text-sm">Baca Selengkapnya →</a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300">
                        ...
                        <div class="p-4">
                            ...
                            <h3 class="text-lg font-bold text-gray-900 mb-2">OPTIMUS 2024</h3>
                            <p class="text-gray-600 text-sm mb-3">Telah terlaksana hari puncak kegiatan OPTIMUS 2024 pada Minggu, 27 Oktober 2024...</p>
                            <a href="#" class="text-primary hover:text-primary-dark font-semibold text-sm">Baca Selengkapnya →</a>
                        </div>
                    </div>
                </div>
